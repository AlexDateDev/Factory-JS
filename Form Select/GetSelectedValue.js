...
function sl_s_v( domObj,v )
    {
    var s=domObj.selectedIndex;
    if(arguments.length==1)
    {
        return s!=-1?domObj.options[s].value:null;
    }
    else
    {
        if(s != -1)
            domObj.options[s].value=v
    }
}
...
<BODY>
    <FORM NAME="datos">
    <INPUT TYPE="Button" NAME="BTN" VALUE="set selected value" onClick="set()"><INPUT TYPE="input" id="i1"><p>
    <INPUT TYPE="Button" NAME="BTN" VALUE="get selected value" onClick="get()"><INPUT TYPE="input" id="i2"><p>
