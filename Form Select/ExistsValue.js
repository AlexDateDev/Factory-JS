...
function sl_e_v( domObj, text )
    {
    for( var i=domObj.length-1; i>=0; i-- )
        {
        if( text.toUpperCase( ) == domObj.options[ i ].value.toUpperCase( ))
            return  true;
        }
    return false;
    }
...
<HEAD>
    ...
    <SCRIPT SRC="sl_e_v.js"></SCRIPT>
    <SCRIPT LANGUAGE="JAVASCRIPT">
    function set( )
    {
        var s = document.getElementById( "s" );
        var i = document.getElementById( "i1" );
        alert( sl_e_v( s, i.value ));
    }
    function get( )
    {
        var s = document.getElementById( "s" );
...
<BODY>
    <FORM NAME="datos">
    <INPUT TYPE="Button" NAME="BTN" VALUE="exist value" onClick="set()"><INPUT TYPE="input" id="i1"><p>
Existen valores vacios
     <SELECT size="4" id="s" name="elegir-componente">
      <OPTION selected value="v1">Componente_1</OPTION>
      <OPTION selected value="v2">Componente_2</OPTION>
