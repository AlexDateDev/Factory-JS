...
function sl_impl_t( domObj, sep )
{
    ...
    {
        all = (i==0)? domObj.options[ i ].text : all + sep + domObj.options[ i ].text;
    }
    return all;
}
<HTML>
<HEAD>
    ...
    <SCRIPT SRC="sl_impl_t.js"></SCRIPT>
    <SCRIPT LANGUAGE="JAVASCRIPT">
    function set( )
    {
        var s = document.getElementById( "s" );
        var i = document.getElementById( "i1" );
        alert( sl_impl_t( s, i.value ) );
    }
    function get( )
    {
        var s = document.getElementById( "s" );
...
<BODY>
    <FORM NAME="datos">
    <INPUT TYPE="Button" NAME="BTN" VALUE="get implode text" onClick="set()">separador<INPUT TYPE="input" id="i1"><p>
