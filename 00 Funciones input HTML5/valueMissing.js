    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function enviar(){
                ...
                else if( cuadro_usuario.validity.valueMissing){    /* Miramos si existe valor */
                    alert("No se ha indicado del nombre");
                }
            }
    ...
    <body>
        <section>
            <form name="datos_usuario" id="datos_usuario" method="get" >
                Nombre: <input pattern="[A-Za-z]{3}" name="nombre" id="nombre" required /><br />
